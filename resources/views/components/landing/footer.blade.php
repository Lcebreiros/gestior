    ...
    <div class="footer-container">
        ...
        <div class="footer-grid">
            ...
            <div class="footer-brand">
                <a href="{{ route('home') }}">
                    <img src="{{ asset('images/helipso.png') }}" alt="Helipso" class="footer-logo">
                </a>
            </div>
            ...
            <div>
                ...
                <a href="mailto:soporte@helipso.com.ar" class="footer-email">
            ...
            <div>
                ...
                <div class="footer-social">
                    <a href="https://instagram.com/helipso" target="_blank" rel="noopener noreferrer" class="footer-social-link" aria-label="Instagram">
        ...
        <div class="footer-bottom">
            <p class="footer-copyright">
                © {{ date('Y') }} Helipso. Todos los derechos reservados. Desarrollado por Leandro Cebreiros
            </p>
        </div>
    </div>
</footer>
