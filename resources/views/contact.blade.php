    ...
    <section class="relative bg-black text-white py-24">
        ...
        <div class="contact-container">
            ...
            <div class="contact-card" style="margin-bottom: 1rem;">
                ...
                <a class="contact-link" href="mailto:soporte@helipso.com.ar">soporte@helipso.com.ar</a>
            </div>
            ...
            <div class="contact-card" style="gap: 0.75rem;">
                ...
                <a class="contact-link" href="https://instagram.com/helipso" target="_blank" rel="noopener noreferrer">@helipso</a>
            </div>
        </div>
    </section>
</x-guest-layout>
