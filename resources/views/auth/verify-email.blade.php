...
<head>
    ...
    <title>Verificar Email - {{ config('app.name', 'Helipso') }}</title>
        ...
        <div class="card">
            ...
            @if (session('status') == 'verification-link-sent')
                <div class="success-message">
                    ...
                    <span>¡Listo! Te hemos enviado un nuevo enlace de verificación al correo que proporcionaste.</span>
                </div>
            @endif
            ...
            <div class="message">
                ...
                <p style="margin-top: 1rem;">
                    Si no recibiste el email, estaremos encantados de enviarte otro.
                </p>
            </div>
            ...
            <div class="links-container">
                <a href="{{ route('profile.show') }}" class="link">
                    ← Editar perfil
                </a>
            ...
            <div class="help-text">
                ¿Problemas? Revisa tu carpeta de spam o <a href="{{ route('profile.show') }}" class="link">actualiza tu email</a>
            </div>
        </div>
    </div>
</body>
